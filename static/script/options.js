    ...
    tabs.createTab('tabs', app.createElement(
        ...
        [
            ...
            app.createElement('section', [
                ...
                app.createElement('p', 'Change the icon of Incognito\'s browser tab. To change it into something like Google Classroom, type in "https://ssl.gstatic.com/classroom/favicon.png"', {
                    style: {
                        'margin-bottom': '0'
                    }
                })
